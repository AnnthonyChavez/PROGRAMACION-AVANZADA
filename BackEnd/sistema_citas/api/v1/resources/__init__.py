...
# Importa las clases de recursos
from api.v1.resources.paciente import PacienteResource
from api.v1.resources.medico import MedicoResource
from api.v1.resources.consultorio import ConsultorioResource
from api.v1.resources.cita import CitaResource
